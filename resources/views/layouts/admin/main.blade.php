                    ...
                    <nav class="pcoded-navbar">
                        <div class="nav-list">
                            <div class="pcoded-inner-navbar main-menu">
                                ...
                                <ul class="pcoded-item pcoded-left-item">
                                    <li class="pcoded-hasmenu @if($page == '/index' || $page == '/news/create' || $page == '/news/list' ) active
                                        pcoded-trigger @endif">
                                        <a href="javascript:void(0)" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="feather icon-clipboard"></i></span>
                                ...
                                <ul class="pcoded-item pcoded-left-item">
                                    <li class="pcoded-hasmenu @if($page == '/users' || $page == '/users/create') active
                                        pcoded-trigger @endif">
                                        <a href="javascript:void(0)" class="waves-effect waves-dark">
                                ...
                                <ul class="pcoded-item pcoded-left-item">
                                    <li class="pcoded-hasmenu @if($page == '/customer' || $page == '/customer/create') active
                                        pcoded-trigger @endif">
                                        <a href="javascript:void(0)" class="waves-effect waves-dark">
                                            <span class="pcoded-micon">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class="@if($page == '/customer')  active pcoded-trigger @endif">
                                                <a href="{{url('/customer/index')}}" class="waves-effect waves-dark">
                                                    <span class="pcoded-mtext">ข้อมูลลูกค้า</span>
                                                </a>
                                            </li>
                                            <li class="@if($page == '/customer/create')  active pcoded-trigger @endif">
                                                <a href="{{url('/customer/create')}}" class="waves-effect waves-dark">
                                                    <span class="pcoded-mtext">เพิ่มข้อมูลลูกค้า</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="pcoded-hasmenu @if($page == '/event' || $page == '/event/create') active
                                        pcoded-trigger @endif">
                                        <a href="javascript:void(0)" class="waves-effect waves-dark">
                                            <span class="pcoded-micon">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class="@if($page == '/event')  active pcoded-trigger @endif">
                                                <a href="{{url('/customer/index_event')}}" class="waves-effect waves-dark">
                                                    <span class="pcoded-mtext">ข้อมูลจัดงาน</span>
                                                </a>
                                            </li>
                                            <li class="@if($page == '/event/create')  active pcoded-trigger @endif">
                                                <a href="{{url('/customer/create_event')}}" class="waves-effect waves-dark">
                                ...
                                <ul class="pcoded-item pcoded-left-item">
                                    <li class="pcoded-hasmenu @if($page == '/product' || $page == '/product/create') active
                                        pcoded-trigger @endif">
                                        <a href="javascript:void(0)" class="waves-effect waves-dark">
                                            <span class="pcoded-micon">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class="@if($page == '/product')  active pcoded-trigger @endif">
                                                <a href="{{url('/product/index')}}" class="waves-effect waves-dark">
                                                    <span class="pcoded-mtext">ข้อมูลสินค้า</span>
                                                </a>
                                            </li>
                                            <li class="@if($page == '/product/create')  active pcoded-trigger @endif">
                                                <a href="{{url('/product/create')}}" class="waves-effect waves-dark">
                                                    <span class="pcoded-mtext">เพิ่มข้อมูลสินค้า</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="pcoded-hasmenu @if($page == '/producttype' || $page == '/producttype/create') active
                                        pcoded-trigger @endif">
                                        <a href="javascript:void(0)" class="waves-effect waves-dark">
                                            <span class="pcoded-micon">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class="@if($page == '/producttype')  active pcoded-trigger @endif">
                                                <a href="{{url('/product/index_type')}}" class="waves-effect waves-dark">
                                                    <span class="pcoded-mtext">ข้อมูลประเภทสินค้า</span>
                                                </a>
                                            </li>
                                            <li
                                                class="@if($page == '/producttype/create') active pcoded-trigger @endif">
                                                <a href="{{url('/product/create_type')}}" class="waves-effect waves-dark">
                                                    <span class="pcoded-mtext">เพิ่มประเภทสินค้า</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="pcoded-hasmenu @if($page == '/productunit' || $page == '/productunit/create_unit') active
                                        pcoded-trigger @endif">
                                        <a href="javascript:void(0)" class="waves-effect waves-dark">
                                            <span class="pcoded-micon">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class="@if($page == '/productunit')  active pcoded-trigger @endif">
                                                <a href="{{url('/product/index_unit')}}" class="waves-effect waves-dark">
                                                    <span class="pcoded-mtext">ข้อมูลปริมาณหน่วยสินค้า</span>
                                                </a>
                                            </li>
                                            <li
                                                class="@if($page == '/productunit/create_unit') active pcoded-trigger
                                                @endif">
                                    ...
                                    <li class="pcoded-hasmenu @if($page == '/material' || $page == '/material/create') active
                                        pcoded-trigger @endif">
                                        <a href="javascript:void(0)" class="waves-effect waves-dark">
                                            <span class="pcoded-micon">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class="@if($page == '/material')  active pcoded-trigger @endif">
                                                <a href="{{url('/product/material_index')}}" class="waves-effect waves-dark">
                                                    <span class="pcoded-mtext">ข้อมูลวัตถุดิบ</span>
                                                </a>
                                            </li>
                                            <li class="@if($page == '/material/create') active pcoded-trigger @endif">
                                                <a href="{{url('/product/material_create')}}" class="waves-effect waves-dark">
                                ...
                                <ul class="pcoded-item pcoded-left-item">
                                    <li class="pcoded-hasmenu @if($page == '/production' || $page == '/production/create') active
                                        pcoded-trigger @endif">
                                        <a href="javascript:void(0)" class="waves-effect waves-dark">
                                            <span class="pcoded-micon">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class="@if($page == '/production')  active pcoded-trigger @endif">
                                                <a href="{{url('/production/production_index')}}" class="waves-effect waves-dark">
                                                    <span class="pcoded-mtext">ข้อมูลรายการผลิต</span>
                                                </a>
                                            </li>
                                            <li class="@if($page == '/production/create') active pcoded-trigger @endif">
                                                <a href="{{url('/production/production_create')}}" class="waves-effect waves-dark">
                                ...
                                <ul class="pcoded-item pcoded-left-item">
                                    <li class="pcoded-hasmenu @if($page == '/withdraw_product' || $page == '/withdraw/withdraw_product_create') active
                                        pcoded-trigger @endif">
                                        <a href="javascript:void(0)" class="waves-effect waves-dark">
                                            <span class="pcoded-micon">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class="@if($page == '/withdraw_product')  active pcoded-trigger @endif">
                                                <a href="{{url('/withdraw/withdraw_product')}}" class="waves-effect waves-dark">
                                            ...
                                            <li class="@if($page == '/withdraw/withdraw_product_create') active pcoded-trigger @endif">
                                                <a href="{{url('/withdraw/withdraw_product_create')}}" class="waves-effect waves-dark">
                                                    <span class="pcoded-mtext">เพิ่มข้อมูลเบิกสินค้า</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                     <li class="pcoded-hasmenu @if($page == '/withdraw_material' || $page == '/withdraw/withdraw_material_create') active
                                        pcoded-trigger @endif">
                                         <a href="javascript:void(0)" class="waves-effect waves-dark">
                                             <span class="pcoded-micon">
                                                 <i class="icon-film"></i>
                                         ...
                                         <ul class="pcoded-submenu">
                                             <li
                                                 class="@if($page == '/withdraw_material')  active pcoded-trigger @endif">
                                                 <a href="{{url('/withdraw/withdraw_material')}}" class="waves-effect waves-dark">
                                                     <span class="pcoded-mtext">ข้อมูลเบิกวัตถุดิบ</span>
                                                 </a>
                                             </li>
                                             <li
                                                 class="@if($page == '/withdraw/withdraw_material_create') active
                                                 pcoded-trigger @endif">
