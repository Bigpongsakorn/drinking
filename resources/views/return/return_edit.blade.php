                                            ...
                                            <div class="col-sm-10">
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <label for="">
                                                            ...
                                                            <input type="hidden" name="" id="re_id" value="{{ $customer->re_id }}">
                                                        </label>
                                                    </div>
                                                    <div class="col-sm-6">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select name="" id="" class="form-control material_id">
                                                            ...
                                                            @foreach ($material as $item)
                                                                <option value="{{ $item->material_id }}" @if ($item->material_id == $value->material_id)
                                                                    {{ 'selected' }}
                                                                @else
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="number" class="form-control material_num" id="" value="{{ $value->material_num }}">
                                                    </div>
                                                </div>
                                                @endforeach
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '#create-insert', function() {
                ...
                if (cus_id) {
                    ...
                    $.ajax({
                        method: "POST",
                        url: "/drinking/public/return/return_update",
                        dataType: 'json',
                        cache: false,
                        contentType: false,
                        processData: false,
