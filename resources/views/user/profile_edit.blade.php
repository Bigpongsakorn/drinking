                                            ...
                                            <div class="col-sm-10">
                                                        ...
                                                        @if ($user->position_id == 1 || $user->position_id == 2)
                                                            <select name="select" class="form-control" name="type"
                                                                ...
                                                                @foreach ($position as $value)
                                                                    <option value="{{ $value->position_id }}" @if ($value->position_id == $user->position_id) {{ 'selected' }} @endif>
                                                                        {{ $value->position_name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        @if ($user->position_id == 1 || $user->position_id == 2)
                                                            <input type="text" class="form-control" name="idcart"
                                                                id="idcart" value="{{ $user->emp_id_crad }}"
                                                                maxlength="13">
                                                        @else
                                                            <input type="text" class="form-control" name="idcart"
                                                                id="idcart" value="{{ $user->emp_id_crad }}"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="{{ $user->emp_phonenumber }}" maxlength="10"
                                                            name="tel" id="tel">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select name="select" class="form-control" name="province"
                                                            ...
                                                            @foreach ($province as $item)
                                                                ...
                                                                <option value="{{ $item->province_id }}" @if ($item->province_id == $user->emp_province) {{ 'selected' }} @endif>
                                                                    {{ $item->province_name }}
                                                                </option>
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select name="select" class="form-control" name="district"
                                                            ...
                                                            @foreach ($district as $item)
                                                                <option value="{{ $item->district_id }}" @if ($item->district_id == $user->emp_district) {{ 'selected' }} @endif>
                                                                    {{ $item->district_name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select name="select" class="form-control" name="subdistrict"
                                                            ...
                                                            @foreach ($subistrict as $item)
                                                                <option value="{{ $item->subdistrict_id }}" @if ($item->subdistrict_id == $user->emp_subdistrict) {{ 'selected' }} @endif>
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select name="select" class="form-control" name="zipcode"
                                                            ...
                                                            @foreach ($subistrict as $item)
                                                                <option value="{{ $item->zip_code }}" @if ($item->zip_code == $user->emp_zipcode) {{ 'selected' }} @endif>
                                                                    {{ $item->zip_code }}
                                                                </option>
                                                            @endforeach
                                                        </select>
